...
class Template
{
    ...
    public function __construct()
    {
        ...
        $this->addJS( base_url('js/jquery.js') );
		$this->addJS( base_url('js/ai.js') );
		$this->addJS( base_url('js/jquery-ui.js') );
		$this->addJS( base_url('js/jquery.dataTables.min.js') );
		$this->addCSS( base_url('css/ai.css') );
		$this->addCSS( base_url('css/jquery-ui.css') );
		$this->addCSS( base_url('css/jquery.dataTables.min.css') );
    }
